...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--save_root", type=str, default=None,
                        help="Optional root directory to save results. If not provided, saves to dataset_root.")
    parser.add_argument("--overwrite", action="store_true", help="If set, overwrite existing results. ")
...
def main(args: argparse.Namespace):
    ...
    # Determine save root
    save_root_dir = Path(args.save_root) if args.save_root else args.dataset_root
    ...
    for idx in trange(len(dataset)):
        ...
        # Use save_root_dir instead of color_path.parent.parent
        # Structure: save_root / scene_id / folder_name / file_name
        vis_save_path = save_root_dir / args.scene_id / f"gsa_vis_{save_name}" / color_path.name
        detections_save_path = save_root_dir / args.scene_id / f"gsa_detections_{save_name}" / color_path.name
        ...
        if not args.overwrite and os.path.exists(detections_save_path):
             continue
    ...
    # save global classes
    save_root_dir = Path(args.save_root) if args.save_root else args.dataset_root
    with open(save_root_dir / args.scene_id / f"gsa_classes_{save_name}.json", "w") as f:
